...
/***/ function(module, exports, __webpack_require__) {
	...
	/* REACT HOT LOADER */ if (false) { (function () { var ReactHotAPI = require("/Users/geowarin/dev/sabri/dicogame-web/node_modules/react-hot-loader/node_modules/react-hot-api/modules/index.js"), RootInstanceProvider = require("/Users/geowarin/dev/sabri/dicogame-web/node_modules/react-hot-loader/RootInstanceProvider.js"), ReactMount = require("react/lib/ReactMount"), React = require("react"); module.makeHot = module.hot.data ? module.hot.data.makeHot : ReactHotAPI(function () { return RootInstanceProvider.getRootInstances(ReactMount); }, React); })(); } try { (function () {

	/// <reference path="./typings/tsd.d.ts" />
	var React = __webpack_require__(2);
	var App_1 = __webpack_require__(153);
	React.render(React.createElement(App_1.default, null), document.getElementById('app'));


	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/geowarin/dev/sabri/dicogame-web/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "index.tsx" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = (function (_super) {
	    ...
	    App.prototype.componentDidMount = function () {
	        var _this = this;
	        axios.get('./fr-en.json').then(function (response) {
	            var dico = response.data;
	            var randomKey = App.getRandomKey(dico);
	            _this.moreState({
	                word: randomKey,
	                acceptedAnswers: dico[randomKey],
	            });
	            var el = React.findDOMNode(_this.refs['answerInput']);
	            el.focus();
	        });
	    };
	    App.getRandomKey = function (obj) {
	        var keys = Object.keys(obj);
	        return keys[keys.length * Math.random() << 0];
	    };
	    App.prototype.onAnwser = function () {
	        console.log('anwser', this.state.answer);
	        if (this.state.acceptedAnswers.indexOf(this.state.answer.toLowerCase()) === -1) {
	            this.moreState({ result: 'Fail! Accepted answers were ' + this.state.acceptedAnswers.toString() });
	        }
	        else {
	            this.moreState({ result: 'Good answer!' });
	        }
	        setTimeout(function () { return window.location.reload(); }, 2000);
	    };
	    App.prototype.moreState = function () {
	        var sources = [];
	        for (var _i = 0; _i < arguments.length; _i++) {
	            sources[_i - 0] = arguments[_i];
	        }
	        this.setState(assign.apply(void 0, [this.state].concat(sources)));
	    };
	    ...
	    App.prototype.render = function () {
	        var lol = this.state.result;
	        return (React.createElement("div", null, React.createElement("h1", null, "Dicogame"), React.createElement("p", null, "Translate this word: ", React.createElement("b", null, this.state.word)), React.createElement("input", {"type": "text", "value": this.state.answer, "ref": "answerInput", "onChange": this.onChange.bind(this), "onKeyDown": this.onKeyDown.bind(this)}), React.createElement("button", {"onClick": this.onAnwser.bind(this)}, "Answer"), React.createElement("span", null, " ", { lol: lol }, " ")));
	    };
	    return App;
	})(React.Component);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var deprecatedMethod = __webpack_require__(158);
	  ...
	  return new Promise(function (resolve, reject) {
	    try {
	      ...
	      if (typeof window !== 'undefined') {
	        __webpack_require__(161)(resolve, reject, config);
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var urlIsSameOrigin = __webpack_require__(166);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(160), __webpack_require__(169).setImmediate, (function() { return this; }()), __webpack_require__(170)(module)))

/***/ },
/* 169 */
/***/ function(module, exports, __webpack_require__) {

	/* WEBPACK VAR INJECTION */(function(setImmediate, clearImmediate) {var nextTick = __webpack_require__(160).nextTick;
